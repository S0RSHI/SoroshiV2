...
@if($green) bg-green-400 text-white hover:bg-green-500 @elseif ($red) text-white bg-red-600 hover:bg-red-500 @else bg-gray-200 text-gray-800 hover:bg-white @endif">
    {{ $slot }}
</button>
